...
COPY --from=builder /app/target/doctor-service-1.0-SNAPSHOT.jar ./app.jar
...
- **Portlar:** HTTP API için `8083`, gRPC iletişimi için `9005`.
...
- [x] `doguhannilt/doctor-service:1.0.0` imajı başarıyla derlendi.
