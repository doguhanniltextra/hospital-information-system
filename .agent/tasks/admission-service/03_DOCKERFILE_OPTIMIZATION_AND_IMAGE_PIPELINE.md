...
COPY --from=builder /app/target/admission-service-0.0.1-SNAPSHOT.jar ./app.jar
...
- [x] `doguhannilt/admission-service:1.0.0` imajı başarıyla derlendi.
