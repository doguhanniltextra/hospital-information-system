...
Bu doküman, `kubernetes/base/apps/appointment-service/` dizini altında yer alacak, [CHECK_FILE.md](file:///home/doguhan/SoftwareProjects/hospital-information-system/.agent/check/CHECK_FILE.md) üretim kriterlerine tam uyumlu tüm Kubernetes manifestolarını ve Kustomize yapılandırmasını içerir.
...
metadata:
  ...
  labels:
    ...
    app.kubernetes.io/instance: appointment-service
    app.kubernetes.io/component: backend
    app.kubernetes.io/part-of: hospital-information-system
    app.kubernetes.io/managed-by: kustomize
data:
  SERVER_PORT: "8084"
  SPRING_DATASOURCE_WRITE_JDBC_URL: "jdbc:postgresql://postgres:5432/appointment_db?currentSchema=appointment_schema"
  SPRING_DATASOURCE_READ_JDBC_URL: "jdbc:postgresql://postgres:5432/appointment_db?currentSchema=appointment_schema"
...
kind: SecretStore
metadata:
  name: appointment-service-vault-store
  labels:
    app.kubernetes.io/name: appointment-service
    app.kubernetes.io/instance: appointment-service
    app.kubernetes.io/component: backend
...
kind: ExternalSecret
metadata:
  name: appointment-service-vault-secret
  labels:
    app.kubernetes.io/name: appointment-service
    app.kubernetes.io/instance: appointment-service
    app.kubernetes.io/component: backend
...
spec:
  ...
  data:
    - secretKey: SPRING_DATASOURCE_WRITE_USERNAME
      remoteRef:
        key: hospital/appointment-service/db
        property: username
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: appointment-service
          image: doguhannilt/appointment-service:1.0.0
...
kind: NetworkPolicy
metadata:
  name: appointment-service-netpol
  labels:
    app.kubernetes.io/name: appointment-service
    app.kubernetes.io/instance: appointment-service
    app.kubernetes.io/component: backend
...
- [x] `kubernetes/base/apps/appointment-service/` dizini altında 8 adet manifest ve `kustomization.yaml` dosyası oluşturuldu.
...
- [x] `kubectl apply -k kubernetes/base/apps/appointment-service` komutu ile pod `1/1 Running` ve `SecretSynced: True` olarak ayağa kaldırıldı.
